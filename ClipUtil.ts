...
module gamedatingnqp {
    export class ClipUtil extends Laya.Box {
        ...
        //积分轮盘
        public static LUNPAN_FONT: any;
        //绑定送钱
        public static BIND_FONT: any;

        //大厅绑定送钱
        public static DATING_BIND_FONT: any;
        //vip充值
        public static VIP_FONT: any;
        //vip充值2
        public static VIP_FONT0: any;
        //vip等级提升
        public static VIP_UP_FONT: any;
        //余额宝
        public static YUEBAO_FONT: any;
        //转盘字体
        public static TURANBLE_FONT: any;
        //首充字体
        public static SHOUCHONG_FONT: any;
        //首充字体2
    ...
    class ClipCell implements IPoolsObject {
        ...
        public setText(str: any, needZero: boolean = false, isTween: boolean = false, preSkin: string = null, postSkin: string = null): void {
            if ((!str && str != 0) || this._num == str && this._needZero == needZero && this._isTween == isTween && this._preSkin == preSkin && this._postSkin == postSkin) {
                return;
            }
            this._num = str;
